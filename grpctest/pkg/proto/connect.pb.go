...
func (m *DataRequest) GetMessages() int32 {
	if m != nil {
		return m.Messages
	}
	return 0
...
func (m *DataRequest) GetUnits() int32 {
	if m != nil {
		return m.Units
	}
	return 0
...
func (m *DataRequest) GetBufferSize() int32 {
	if m != nil {
		return m.BufferSize
	}
	return 0
...
type DataMessage struct {
	Units                []*DataUnit `protobuf:"bytes,1,rep,name=units,proto3" json:"units,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *DataMessage) GetUnits() []*DataUnit {
	if m != nil {
		return m.Units
	}
	return nil
...
func (m *DataUnit) Reset()         { *m = DataUnit{} }
func (m *DataUnit) String() string { return proto.CompactTextString(m) }
func (*DataUnit) ProtoMessage()    {}
func (*DataUnit) Descriptor() ([]byte, []int) {
	return fileDescriptor_778b7e3040344da6, []int{2}
}
func (m *DataUnit) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DataUnit) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DataUnit.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *DataUnit) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DataUnit.Merge(m, src)
}
func (m *DataUnit) XXX_Size() int {
	return m.Size()
}
func (m *DataUnit) XXX_DiscardUnknown() {
	xxx_messageInfo_DataUnit.DiscardUnknown(m)
}

var xxx_messageInfo_DataUnit proto.InternalMessageInfo

func (m *DataUnit) GetBuffer() []byte {
	if m != nil {
		return m.Buffer
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DataUnit)(nil), "proto.DataUnit")
}
...
var fileDescriptor_778b7e3040344da6 = []byte{
	...
	,
}
...
type DataServiceClient interface {
	Data(ctx context.Context, in *DataRequest, opts ...grpc.CallOption) (DataService_DataClient, error)
}
...
func (c *dataServiceClient) Data(ctx context.Context, in *DataRequest, opts ...grpc.CallOption) (DataService_DataClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DataService_serviceDesc.Streams[0], "/proto.DataService/Data", opts...)
	if err != nil {
		return nil, err
	}
	x := &dataServiceDataClient{stream}
...
type DataService_DataClient interface {
	Recv() (*DataMessage, error)
	grpc.ClientStream
}

type dataServiceDataClient struct {
	grpc.ClientStream
}

func (x *dataServiceDataClient) Recv() (*DataMessage, error) {
	m := new(DataMessage)
...
type DataServiceServer interface {
	Data(*DataRequest, DataService_DataServer) error
}
...
func _DataService_Data_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(DataRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DataServiceServer).Data(m, &dataServiceDataServer{stream})
}

type DataService_DataServer interface {
	Send(*DataMessage) error
	grpc.ServerStream
}

type dataServiceDataServer struct {
	grpc.ServerStream
}

func (x *dataServiceDataServer) Send(m *DataMessage) error {
...
var _DataService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Data",
			Handler:       _DataService_Data_Handler,
			ServerStreams: true,
		},
	},
...
func (m *DataRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Messages != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintConnect(dAtA, i, uint64(m.Messages))
	}
	if m.Units != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintConnect(dAtA, i, uint64(m.Units))
	}
	if m.BufferSize != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintConnect(dAtA, i, uint64(m.BufferSize))
	}
...
func (m *DataUnit) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DataUnit) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Buffer) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintConnect(dAtA, i, uint64(len(m.Buffer)))
...
func (m *DataRequest) Size() (n int) {
	...
	_ = l
	if m.Messages != 0 {
		n += 1 + sovConnect(uint64(m.Messages))
	}
	if m.Units != 0 {
		n += 1 + sovConnect(uint64(m.Units))
	}
	if m.BufferSize != 0 {
		n += 1 + sovConnect(uint64(m.BufferSize))
	}
	if m.XXX_unrecognized != nil {
...
func (m *DataMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Units = append(m.Units, &DataUnit{})
...
func (m *DataUnit) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DataUnit: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DataUnit: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
